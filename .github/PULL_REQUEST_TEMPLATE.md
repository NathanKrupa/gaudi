...
- [ ] Any new, removed, or re-tuned rule cites the principle(s) from [docs/principles.md](../docs/principles.md) it satisfies (or, for removals, the principle it conflicts with)
